                ...
                <div class="row">
                    <table class="table table-dark">
                        <thead>
                            <tr>
                                <th width="10%">ID</th>
                                <th width="15%">名前(name)</th>
                                <th width="15%">性別(gender)</th>
                                <th width="15%">趣味(hobby)</th>
                                <th width="45%">自己紹介(introduction)</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach($posts as $profile)
                                <tr>
                                    ...
                                    <td>{{ Str::limit($profile->hobby, 125) }}</td>
                                    <td>{{ Str::limit($profile->introduction, 125) }}</td>
                                    <td>
                                        <div>
